...
// Material Design Icons: filmstrip-box-multiple (Pictogrammers, Apache-2.0).
// https://github.com/Templarian/MaterialDesign/blob/master/svg/filmstrip-box-multiple.svg
export function FilmstripBoxMultipleIcon(props: SvgIconProps) {
    return (
        <SvgIcon {...props}>
